...
export default function OrdersPage() {
	...
	// Realtime: refresca la lista al instante cuando cambian pedidos o artículos
	// (p. ej. la báscula confirma pesos). No-op si Supabase no está configurado.
	const invalidateOrders = useCallback(() => {
		queryClient.invalidateQueries({ queryKey: invalidateKeys });
	}, [queryClient, invalidateKeys]);
	useRealtimeTable({ table: "orders", onChange: invalidateOrders });
	useRealtimeTable({ table: "order_items", onChange: invalidateOrders });
