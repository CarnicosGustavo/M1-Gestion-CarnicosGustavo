...
const productSchema = z.object({
  ...
  price_per_kg: z.union([z.number(), z.string()]).nullable().transform((v) => (v ? Number(v) : null)),
  unit: z.string().nullable(),
  active: z.boolean(),
  sort_order: z.number().nullable(),
  in_stock: z.union([z.number(), z.string()]).transform((v) => Number(v)),
  ...
  stock_kg: z.union([z.number(), z.string()]).transform((v) => Number(v)),
  is_parent_product: z.boolean(),
  is_sellable_by_unit: z.boolean(),
  is_sellable_by_weight: z.boolean(),
  default_sale_unit: z.string(),
  price_per_piece: z.union([z.number(), z.string()]).nullable().transform((v) => (v ? Number(v) : null)),
